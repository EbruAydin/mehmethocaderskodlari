...
import day15_methodCreation.C01_MethodCreation;
import day15_methodCreation.H01_MethodCreation;
...
public class C01_ForLoop {
	...
	String isim="Aysun";
	String soyisim="Kayaci";

	System.out.println(C01_MethodCreation.isimGizle(isim, soyisim));

		int sayi=8;
		H01_MethodCreation.pozitifMiNegatifMi(sayi);
